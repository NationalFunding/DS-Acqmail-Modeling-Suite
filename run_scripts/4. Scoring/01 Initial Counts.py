...
with open(STAGING_FOLDER + f'/nfqb_{version}.pkl', 'wb') as handle:
...
# file_path = STAGING_FOLDER + f'/nfqb_V7.pkl'
file_path = "/dbfs/FileStore/tables/AMP_staging" + f'/nfqb_V7.pkl'
